        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarBrand = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    CarModel = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    FitYearFrom = table.Column<int>(type: "int", nullable: true),
                    FitYearTo = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiKnowledgeChunks_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiKnowledgeChunks_ProductId",
                table: "AiKnowledgeChunks",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AiKnowledgeChunks_QdrantPointId",
                table: "AiKnowledgeChunks",
